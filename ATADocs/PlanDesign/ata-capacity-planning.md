---
title: "ATA 배포 계획 | Microsoft 고급 위협 분석"
...
# ATA 용량 계획
이 항목은 필요한 ATA 게이트웨이 및 ATA 경량 게이트웨이 수와 ATA 센터 및 ATA 게이트웨이에 대한 서버 용량을 이해하는 것을 포함하여 네트워크를 지원하는 데 필요한 ATA 서버 수를 결정하는 데 도움이 됩니다.
