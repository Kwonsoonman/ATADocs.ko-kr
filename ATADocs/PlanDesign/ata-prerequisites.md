...
ATA 센터를 설치하기 전에 [KB2919355](https://support.microsoft.com/kb/2919355/) 업데이트가 설치되었는지 확인합니다.
...
ATA 게이트웨이를 설치하기 전에 [KB2919355](https://support.microsoft.com/kb/2919355/) 업데이트가 설치되었는지 확인합니다.
...
### 일반
ATA 경량 게이트웨이는 Windows Server 2008 R2 SP1, Windows Server 2012, Windows Server 2012 R2를 실행하는 도메인 컨트롤러에 대한 설치를 지원합니다.
