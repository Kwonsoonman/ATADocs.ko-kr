...
### ATA 게이트웨이의 캡처 네트워크 어댑터를 모두/일부 사용할 수 없음
...
### ATA 게이트웨이가 일부 도메인 컨트롤러에 연결할 수 없음
...
### ATA 게이트웨이가 모든 도메인 컨트롤러에 연결할 수 없음
